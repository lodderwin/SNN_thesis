...
STAGNATIONS_ALLOWED = 5
SPECIATION = True
CROSSOVER_CHANCE = 0.2 # 0.0 means no crossover, all cloning mutations, default 0.75
WEAK_SPECIES_THRESHOLD = 10  #orignal 5
ACTIVATION_THRESHOLD = 0.5
WEIGHT_MUTATION_RATE = 0.8
UNIFORM_WEIGHT_MUTATION_RATE = 0.9
ADD_GENE_MUTATION = 0.15 # Default 0.05
ADD_NODE_MUTATION = 0.12# Default 0.03
