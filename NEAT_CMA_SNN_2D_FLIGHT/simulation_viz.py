...
####
    ...
    def objective_function_multiple(self, model, ref_div, ref_wx, runs):  # add prob here
        ...
        ax.plot(np.arange(len(all_runs_horizontal[nearest_traj_int]))*0.02,all_runs_horizontal[nearest_traj_int],all_runs_vertical[nearest_traj_int], c='#2b54ff', alpha=0.9, label='Actual trajectory')
        ...
        ax.plot(np.arange(len(ref_horizontal))*0.02,ref_horizontal,ref_vertical,  c='#ffa72b', alpha=0.9, label='Reference trajectory')
