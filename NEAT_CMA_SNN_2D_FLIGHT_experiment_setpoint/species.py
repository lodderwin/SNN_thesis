...
####
    ...
    def objective_function_CMAES_single(self, x, genome, ref_div=0.5, ref_wx=0.5):
...
class Species(object):
    ...
    def learn_best_genome(self, div_training, wx_training, genome_id):
        ...
        print('best genome reward', reward)
    ...
    def create_next_generation(self, replicate_ids):
        ...
        while (genome_id < self.species_population):
            ...
            while not learning_condition:
                ...
                # new_weights, best_fitness, condition = cma_es_class.optimize_run(cycles, 0.5, 0.5, temp_genome)
                # if condition:
                #     learning_condition = True
