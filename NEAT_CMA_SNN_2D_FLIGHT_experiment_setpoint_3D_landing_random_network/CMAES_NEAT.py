    ...
    def optimize_run(self, runs, div, wx, wy, genome):
        ...
        for i in range(runs):
            ...
            for k in range(int(self.lamba)):
                ...
                self.arfitness[k] = self.function(self.arx[:,k], div[0], wx[0], wy[0], genome) + self.function(self.arx[:,k], div[1], wx[1], wy[0], genome) + self.function(self.arx[:,k], div[2], wx[2], wy[0], genome) #+ self.function(self.arx[:,k], div[3], wx[3], wy[0], genome) + self.function(self.arx[:,k], div[4], wx[4], wy[0], genome) 
