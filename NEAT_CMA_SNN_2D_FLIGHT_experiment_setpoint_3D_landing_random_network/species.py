...
class Species(object):
    ...
    def run_generation(self, cycle, div_training, wx_training, wy_training):
        if self.active: #this should always be true unless species are allowed to die
            species_fitness = self.generate_fitness(cycle, div_training, wx_training, wy_training)
    ...
    def generate_fitness(self, cycle, div_training, wx_training, wy_training):
        species_score = 0
        genome_scores = {}
