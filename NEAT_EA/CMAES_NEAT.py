    ...
    def optimize_run(self, runs, div, genome):
        for i in range(runs):
            ...
            for k in range(int(self.lamba)):
                ...
                self.arfitness[k] = self.function(self.arx[:,k], div[0], genome) + self.function(self.arx[:,k], div[1]) + self.function(self.arx[:,k], div[2]) + self.function(self.arx[:,k], div[3]) + self.function(self.arx[:,k], div[4]) 
