...
class objective:
    ...
    def visualize_spikes(self, spikes, t):
        ...
        fig.savefig('analysisgroundeffecthovering.png', dpi=100) 
...
####
    ...
    def objective_function_multiple(self, model, ref_div, ref_wx, ref_wy, runs):  # add prob here
        ...
        # self.visualize_spikes(spikes[:,-2000:], self.environment.t)


        return act_horizontal, act_side, act_vertical, spikes
...
act_horizontal, act_side, act_vertical, spikes = objective.objective_function_multiple(model, 0.1, 0.1, 0.1, 1)
