...
act_horizontal, act_side, act_vertical = objective.objective_function_multiple(model, 0.1, 0.1, 0.1, 1)
...
z = np.polyfit(np.arange(0,3000, 1), act_side[-3000:], 3)
plt.plot(act_side[-3000:])
plt.plot(function(np.arange(0,3000, 1), z))
function(np.arange(0,3000, 1), z)
# network_viz.view()
